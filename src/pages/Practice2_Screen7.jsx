  ...
  return (
    <article className="space-y-6">
      ...
      <section className="content-block space-y-6">
        <MathText
          as="p"
          text="В Практике 1 (Лаб 1.1) мы смотрели на распределение доходов населения (`MedInc`) визуально с помощью гистограмм. Теперь пришло время строгой математики. Нужно сформулировать гипотезы о форме распределения и проверить их с помощью статистических критериев согласия на уровне значимости $\\alpha = 0.05$."
