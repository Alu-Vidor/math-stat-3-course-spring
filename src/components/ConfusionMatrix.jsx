      ...
      <div className="grid gap-3 lg:grid-cols-[220px_repeat(2,minmax(0,1fr))]">
        ...
        {columns.map((column) => (
          ...
          >
            ...
            <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">{column.subtitle}</p>
          </div>
        ))}
        ...
        {rows.map((row, rowIndex) => (
          <>
            ...
            >
              ...
              <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">{row.subtitle}</p>
            </div>
